...
const CreateRecord: FC = () => {
	...
	const services = [
		...
		},
		{
			...
			options: [
				{
					label: 'asdasd',
					value: 'asd123s1asdasd'
				}, {
					label: 'asdasd',
					value: 'asd213aass123sdasd'
				}, {
					label: 'asdasd',
					value: 'asdas1231231dsadasd'
				}, {
					label: 'asdasd',
					value: 'asdas121dasd'
				}, {
					label: 'asdasd',
					value: 'asd123123as122dasd'
				}
			]
		}
	];
	...
	return (
		<ModalManager type={MODALS.CREATE_RECORD}>
			<Box>
				<Typography sx={{mb: 1}} variant={'h6'}>{t('records:userRecord')}</Typography>
				<Box sx={{
					display: 'flex',
					...
					<FormControl fullWidth>
						<Select
							...
							placeholder={t('records:selectService')}
							styles={{
								control: (styles) => ({
									...styles,
									padding: '7px 5px',
					...
					<Box sx={{
						...
						<DateTimePicker
							label={t('records:startOfSession')}
